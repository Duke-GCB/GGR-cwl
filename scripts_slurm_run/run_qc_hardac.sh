...
srun cwltool --preserve-environment PATH --outdir ~/data-tmp/fastq-out --no-container ~/workspace/GGR-cwl/GGR_ChIP-seq_pipeline/01-qc.cwl  ~/workspace/GGR-cwl/GGR_ChIP-seq_pipeline/01-qc.json
